...
public class FieldComparator implements Comparator<BibtexEntry> {
	...
	public FieldComparator(String field, boolean reversed) {
        ...
        this.field = field.split(Globals.COL_DEFINITION_FIELD_SEPARATOR);
	...
	public int compare(BibtexEntry e1, BibtexEntry e2) {
		...
		if (isNameField) {
			 ...
			 */
			f1 = Integer.valueOf(Util.getMonthNumber((String)f1));			
			f2 = Integer.valueOf(Util.getMonthNumber((String)f2));
		}
        ...
        if (isNumeric) {
            ...
            if (i2 != null && i1 != null) {
                ...
                f1 = i1;
                f2 = Integer.valueOf(i1.intValue()+1);
            } else if (i2 != null) {
                // The second one was parseable, but not the first one.
                // This means we consider one > two
                f2 = i2;
                f1 = Integer.valueOf(i2.intValue()+1);
            }
